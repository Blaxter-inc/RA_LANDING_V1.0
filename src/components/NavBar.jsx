...
import { menu, sm_logo, close } from "../assets";
...
const NavBar = () => {
  ...
  return (
    <nav className="w-full flex py-6 justify-between items-center navbar">
      <img src={sm_logo} alt="Ra_logo" className="w-[80px] h-[100px]" />
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        <img src={toggle ? close : menu} alt="menu" className="w-[28px] h-[28px] object-contain" onClick={toggleMenu} />
